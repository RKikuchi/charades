...
import br.com.kiks.charades.adapters.CategoryCatalogPagerAdapter;
import br.com.kiks.charades.async.OnlineCategoriesLoader;
        ...
        switch (requestCode) {
            case REQUEST_CODE_MANAGE_CATEGORY:
                ...
                getContentResolver().delete(
                        Uri.parse("content://br.com.kiks.charades.categorytagsuggestion"),
                        null, null);
                break;
        }
